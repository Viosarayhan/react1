...
export default function Card({product}) {
  return (
    ...
    <div className="flex flex-col max-w-[400px] flex-wrap p-[16px] bg-[#081116] " >
          <img src={product.imageUrl ?? ''} alt={product.name ?? 'No name'} className="block max-h-[600px] mb-4 object-cover" />
            <div className="flex flex-col gap-2">
                ...
                {product.stock <= 0 ? (
                    ...
                    <>
                       <p className="text-xl font-semibold text-center text-yellow-500 mb-3">Almost Sold Out</p>
